...
export class RibbonVolatility extends ethereum.SmartContract {
  static bind(address: Address): RibbonVolatility {
    return new RibbonVolatility("RibbonVolatility", address);
  }
