...
contract UniswapAdapter is Ownable{
   ...
   function _convertEthToToken( uint256 inputAmount, address addr, IUniswapV2Router02 router) internal {
    ...
    function _convertTokenToToken(address addr1, address addr2, uint256 amount,IUniswapV2Router02 router) internal {
        uint deadline = block.timestamp + 150;
